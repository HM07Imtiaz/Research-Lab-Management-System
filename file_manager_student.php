    ...
    <div style="height: auto; display: flex;margin-top: 30px;  ">
        <div style="width : 70%; margin-left : 120px;margin-top : 120px;">
            <div class="container" style="display: flex;justify-content: center;align-items: center;height: auto;">
                <div class="folder" onclick="location.href='file_manager_student.php?type=B.Sc'">
                    <h1>B.Sc</h1>
                </div>
                <div class="folder" onclick="location.href='file_manager_student.php?type=M.Sc'">
                    <h1>M.Sc</h1>
                </div>
                <div class="folder" onclick="location.href='file_manager_student.php?type=PhD'">
                    <h1>PhD</h1>
                </div>
            </div>
